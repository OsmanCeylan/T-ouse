#############################################################################
# Makefile for building: usbCS
# Generated by qmake (3.1) (Qt 5.13.2)
# Project:  usbCS.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile usbCS.pro
#############################################################################
...
CXX           = g++
DEFINES       = 
CFLAGS        = -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fno-plt -Wall -W -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fno-plt -std=gnu++11 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -isystem /usr/include/libusb-1.0 -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = usbCS1.0.0
DISTDIR = /home/osman/QtProjects/usbCS/.tmp/usbCS1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) -lusb-1.0   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: usbCS.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
